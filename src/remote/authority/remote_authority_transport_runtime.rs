...
pub struct SendOpenMirrorRequestArgs<'a> {
    ...
    pub bootstrap_mode: crate::infra::remote_protocol::BootstrapMode,
}

pub struct SendRawPtyInputArgs<'a> {
    pub session_id: &'a str,
    pub target_id: &'a str,
    pub console_id: &'a str,
    pub attachment_id: &'a str,
    pub console_host_id: &'a str,
    pub input_seq: u64,
...
impl RemoteAuthorityTransportRuntime {
    ...
    pub fn send_open_mirror_request(
        &self,
        args: SendOpenMirrorRequestArgs<'_>,
    ) -> Result<(), RemoteAuthorityTransportError> {
        self.send_payload(
            args.session_id,
            args.target_id,
            ControlPlanePayload::OpenMirrorRequest(OpenMirrorRequestPayload {
                ...
                console_id: args.console_id.to_string(),
                cols: args.cols,
                rows: args.rows,
                raw_pty_passthrough: args.raw_pty_passthrough,
    ...
    pub fn send_target_exited(
        ...
        self.send_payload(
            ...
            ControlPlanePayload::TargetExited(TargetExitedPayload {
                ...
                revision: 0,
                authority_host_session_name: Some(authority_host_session_name.to_string()),
            }),
        )
    }
    ...
    pub fn send_raw_pty_input(
        ...
        self.send_payload(
            ...
            ControlPlanePayload::RawPtyInput(RawPtyInputPayload {
                ...
                target_id: args.target_id.to_string(),
                console_id: args.console_id.to_string(),
                attachment_id: args.attachment_id.to_string(),
                console_host_id: args.console_host_id.to_string(),
            ...
            Ok(frame) => {
                ...
                let frame = match frame {
                    AuthorityTransportFrame::ControlPlane(envelope) => match envelope.payload {
                        ...
                        payload => {
                            AuthorityTransportFrame::ControlPlane(Box::new(ProtocolEnvelope {
                                payload,
                                ..*envelope
                            }))
                        }
